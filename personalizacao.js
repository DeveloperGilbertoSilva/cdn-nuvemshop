(function () {
    ...
    var myAppJavaScript = function ($) {
        ...
        var possiveis_valores = ['Com Personalização', 'COM PERSONALIZAÇÃO', 'com personalização', 'Sim', 'SIM', 'sim', 'com modificação', 'COM MODIFICAÇÃO', 'Com modificação', 'Quero meu nome', 'Com nome'];
