(function () {
    ...
    var myAppJavaScript = function ($) {
        ...
        var possiveis_valores = ['Com Personalização', 'COM PERSONALIZAÇÃO', 'Com personalização', 'Com personalização (Nome + Número)', 'com personalização', 'Sim', 'SIM', 'sim', 'com modificação', 'COM MODIFICAÇÃO', 'Com modificação', 'Quero meu nome', 'Personalizada'];
                ...
                $(query).each(function (index) {
                    ...
                    select.change(function () {
                        if (possiveis_valores_string.indexOf(select.val()) != -1) {
                            ...
                            $(".div_propertie_camisa input").val("");
